...
import logo02 from '../assets/images/icons/logo-02.png'
          ...
          <div className="row">
            <div className="col-lg-4 p-b-20">
              <div className="size-h-3 flex-s-c">
                <a href="index.html">
                  <img className="max-s-full" src={logo02} alt="LOGO" />
                </a>
              </div>
              <div>
      ...
      <div className="bg11">
        <div className="container size-h-4 flex-c-c p-tb-15">
          <span className="f1-s-1 cl0 txt-center">
            Copyright © 2018 
            <a href="#" className="f1-s-1 cl10 hov-link1">Colorlib.</a>
            All rights reserved.
          </span>
        </div>
      </div>
